...
<script>
    ...
    // SCRIPT SWEETALERT (TOLAK, SETUJUI, HAPUS DENGAN ANIMASI)
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Swal.fire({ 
                    ...
                    willClose: () => { document.getElementById(`approve-form-${id}`).submit(); }
                });
            }
        });
    }
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Swal.fire({ 
                    ...
                    text: 'Permohonan peminjaman telah ditolak.',
                    icon: 'error', 
                    showConfirmButton: false, 
                    timer: 1200, 
                    timerProgressBar: true,
                    willClose: () => { document.getElementById(`reject-form-${id}`).submit(); }
                });
            }
        });
    }
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                Swal.fire({ 
                    ...
                    icon: 'success', 
                    showConfirmButton: false, 
                    timer: 1500, // Ditingkatkan sedikit agar animasi terlihat jelas
                    timerProgressBar: true,
                    willClose: () => { 
                ...
                // Animasi/notif lembut saat tombol 'Tidak' / 'Batal' ditekan
                Swal.fire({
                    title: 'Dibatalkan',
